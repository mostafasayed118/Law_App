...
- Tests (1011 total): Result, AppError, UseCase, ViewState, AuthCubit (demo
  ...
  assertions.
- Coverage: **1011 tests** (2026-08-08, realtime T7 — the env-gated
  `fetchMessages` swap + `Message` VO + the read-only thread-detail surface,
