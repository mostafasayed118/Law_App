...
- Tests (1385 total): Result, AppError, UseCase, ViewState, AuthCubit (demo
  ...
  assertions.
- Coverage: **1385 tests** (2026-09-22 — the P1.7 state-honesty slice: a typed
...
`docs/current_applied_surface_2026-08-08.md` §1d). Current suite: **1388
tests passing** (1385 tracked declarations, ledger `verify_ledger.sh` PASS).
