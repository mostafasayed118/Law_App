...
- Tests (950 total): Result, AppError, UseCase, ViewState, AuthCubit (demo
  ...
  assertions.
- Coverage: **950 tests** (2026-08-08, storage T7 — the env-gated
  `StorageGateway` swap + `matter_files_section`); `flutter analyze` and the
  format gate
