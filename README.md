...
- Tests (1231 total): Result, AppError, UseCase, ViewState, AuthCubit (demo
  ...
  assertions.
- Coverage: **1231 tests** (2026-08-11 — pattern-B follow-up: shared
  `ViewStateList` (the note-wrapped ListView arms of the approvals,
