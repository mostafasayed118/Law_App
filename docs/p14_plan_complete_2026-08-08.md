...
| 5 | Audit surfacing (client-only; RPCs pre-applied 2026-08-01) | 2026-08-08 | ✅ (RPCs applied + battery-pinned; 18-of-18 wired) | `docs/audit_surfacing_plan_2026-08-08.md` / `docs/audit_surfacing_completion_evidence_2026-08-08.md` | 986 / 983 |
